...
- `project/Hatchling Quest 1.html` — All UI rendering (HUD, dialogue, prompts, debug)
- `project/Hatchling.html` — Title screen (if used)
- `project/Hatchling Threads.html` — Thread viewer UI
- `project/Hatchling Quest Editor.html` — Editor interface
