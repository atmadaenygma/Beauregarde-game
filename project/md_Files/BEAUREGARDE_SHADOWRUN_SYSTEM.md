# BEAUREGARDE — Shadowrun Genesis Quest System: Design Decisions

## Reference Model: Shadowrun Genesis (Sega Genesis, 1994)

Beauregarde's questing system is built on the **information economy framework** from Shadowrun Genesis, but adapted for a community-solidarity model instead of a transactional one.
...
- Beauregarde is community/solidarity (people share within their network)
...
## Summary: Shadowrun Genesis Adapted for Beauregarde

| Shadowrun Element | Beauregarde Adaptation | Why |
|-------------------|----------------------|-----|
...
**The Core Transfer:**
Shadowrun Genesis's **information economy** (information as currency for progression) becomes Beauregarde's **information intimacy** (information as deepening trust and understanding).
...
- **Beauregarde:** "I'm trusting you with this information"

Both create progression and discovery. But Beauregarde's version is rooted in community, vulnerability, and mutual aid rather than commerce and individualism.
