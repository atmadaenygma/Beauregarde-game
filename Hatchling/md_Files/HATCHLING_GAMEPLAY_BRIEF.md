# HATCHLING — Gameplay Design Brief
...
Hatchling's questing system is inspired by **Shadowrun Genesis (Sega Genesis, 1994)** — specifically its **keyword and information economy system.**
...
**The Core Mechanic (Shadowrun → Hatchling):**
```
...
HATCHLING: Conversation flow system  
...
- Hatchling: relational (trust for information)
- Shadowrun: keyword-gated
- Hatchling: conversation-flow-gated
- Shadowrun: information is tradeable
- Hatchling: information is shared within community
...
There is no visual fog boundary for her. The Veil isn't invisible to her — it's invisible to white people. She moves seamlessly between The Veil and white Hatchling. The transition is **social and atmospheric, not visual.**
...
### Power & Invisibility
- White Hatchling can't see The Veil (won't look)
